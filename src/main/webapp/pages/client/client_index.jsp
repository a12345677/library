    ...
    <script type="text/javascript">
        $(function () {
            $(".addToCart").click(function () {
                ...
                //location.href = "http://localhost:8080/project/CartServlet?action=add&id=" + bookId;
                $.getJSON("http://localhost:8080/project/CartServlet",
                    "action=ajaxAdd&id=" + bookId,
                    function (data) {
                    $("#cartTotalCount").text("您的购物车中有"+data.totalCount+"件商品")
                })
                // axios({
                //     method:"get",
                //     url:"http://localhost:8080/project/CartServlet?action=ajaxAdd&id="+bookId,
                //
                // }).then(function (resp){
                //     alert(resp.data);
                // })
